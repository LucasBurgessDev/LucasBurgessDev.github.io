        ...
        <div className="cards__container">
            <div className="cards__wrapper">
                <ul className="cards__items">
                    <CardItem
                    src={ImageTerraform}
                    text='Create infrastructure on demand with Terraform'
                    label='DevOps/IaC'
                    path='/Projects'
                    />
                    <CardItem
                    src={ImageADF}
                    text='Data ELT with Azure Data Factory, Data Lake and SQL'
                    label='Data'
                    path='/Projects'
                    />
                </ul>
                <ul className='cards__items'>
                    <CardItem
                    src={ImageStream}
                    text='Data Streaming with Azure Event Hubs and IBM MQ'
                    label='Data'
                    path='/Projects'
                    />
                    <CardItem
                    src={ImagePython}
                    text='Python based ETL with Azure Databricks utilising Spark'
                    label='Data'
                    path='/Projects'
                    />
                    <CardItem
